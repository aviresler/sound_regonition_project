...
def configure():
    ...
    flags.DEFINE_integer('num_epochs', 1500, 'maximum number of num_epochs')
    flags.DEFINE_float('lr_schedule', [600.0, 1200.0], 'after this amount of epochs, the learning rate is divided by 10')
    ...
    flags.DEFINE_bool('is_between_class_train', True, 'between class flag')
