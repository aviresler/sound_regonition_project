...
def configure():
    ...
    # training
    flags.DEFINE_float('initial_learning_rate', 0.0001, 'learning rate')
    flags.DEFINE_integer('num_epochs', 31, 'maximum number of num_epochs')
    ...
    flags.DEFINE_string('pretrain_file', 'backupBase1_reduceLR/model/model.ckpt-20', 'pre-trained model filename corresponding to encoder_name')
